...
use fiber_v061::fiber::channel::ChannelActorState as NewChannelActorState;
...
impl Migration for MigrationObj {
    fn migrate<'a>(
        ...
        {
            let res = bincode::deserialize::<NewChannelActorState>(&v).expect("serialized failed");
            let payment_hash = res.local_pubkey;
