...
impl From<[Byte; 65usize]> for Signature {
    fn from(value: [Byte; 65usize]) -> Self {
...
impl ::core::convert::TryFrom<&[Byte]> for Signature {
    ...
    fn try_from(value: &[Byte]) -> Result<Self, ::core::array::TryFromSliceError> {
        Ok(Self::new_builder()
            .set(<&[Byte; 65usize]>::try_from(value)?.clone())
            .build())
    }
}
impl From<Signature> for [Byte; 65usize] {
    #[track_caller]
...
impl From<[u8; 65usize]> for Signature {
    fn from(value: [u8; 65usize]) -> Self {
...
impl ::core::convert::TryFrom<&[u8]> for Signature {
    ...
    fn try_from(value: &[u8]) -> Result<Self, ::core::array::TryFromSliceError> {
        Ok(<[u8; 65usize]>::try_from(value)?.into())
    }
}
impl From<Signature> for [u8; 65usize] {
    #[track_caller]
    fn from(value: Signature) -> Self {
        ::core::convert::TryFrom::try_from(value.as_slice()).unwrap()
    }
}
impl<'a> From<SignatureReader<'a>> for &'a [u8; 65usize] {
    #[track_caller]
    fn from(value: SignatureReader<'a>) -> Self {
        ::core::convert::TryFrom::try_from(value.as_slice()).unwrap()
    }
}
impl<'a> From<&'a SignatureReader<'a>> for &'a [u8; 65usize] {
    #[track_caller]
...
impl From<Uint64> for AmountOpt {
...
impl From<Byte32> for SiPrefixOpt {
...
impl From<TestMessage> for PCNMessage {
    fn from(value: TestMessage) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<OpenChannel> for PCNMessage {
    fn from(value: OpenChannel) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<AcceptChannel> for PCNMessage {
    fn from(value: AcceptChannel) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<CommitmentSigned> for PCNMessage {
    fn from(value: CommitmentSigned) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<TxSignatures> for PCNMessage {
    fn from(value: TxSignatures) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<ChannelReady> for PCNMessage {
...
impl From<TxComplete> for PCNMessage {
    fn from(value: TxComplete) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<TxAbort> for PCNMessage {
    fn from(value: TxAbort) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<TxInitRBF> for PCNMessage {
    fn from(value: TxInitRBF) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<TxAckRBF> for PCNMessage {
    fn from(value: TxAckRBF) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<Shutdown> for PCNMessage {
    fn from(value: Shutdown) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<ClosingSigned> for PCNMessage {
    fn from(value: ClosingSigned) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<AddTlc> for PCNMessage {
    fn from(value: AddTlc) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<TlcsSigned> for PCNMessage {
    fn from(value: TlcsSigned) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<RevokeAndAck> for PCNMessage {
    fn from(value: RevokeAndAck) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<RemoveTlc> for PCNMessage {
...
#[derive(Clone)]
pub struct PaymentHashOpt(molecule::bytes::Bytes);
impl ::core::fmt::LowerHex for PaymentHashOpt {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::core::fmt::Debug for PaymentHashOpt {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::core::fmt::Display for PaymentHashOpt {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        if let Some(v) = self.to_opt() {
            write!(f, "{}(Some({}))", Self::NAME, v)
        } else {
...
impl ::core::default::Default for PaymentHashOpt {
    fn default() -> Self {
        let v = molecule::bytes::Bytes::from_static(&Self::DEFAULT_VALUE);
        PaymentHashOpt::new_unchecked(v)
    }
}
impl PaymentHashOpt {
    const DEFAULT_VALUE: [u8; 0] = [];
    ...
    pub fn to_opt(&self) -> Option<PaymentHash> {
        if self.is_none() {
            None
        } else {
            Some(PaymentHash::new_unchecked(self.0.clone()))
        }
    }
    pub fn as_reader<'r>(&'r self) -> PaymentHashOptReader<'r> {
        PaymentHashOptReader::new_unchecked(self.as_slice())
    }
}
impl molecule::prelude::Entity for PaymentHashOpt {
    type Builder = PaymentHashOptBuilder;
    const NAME: &'static str = "PaymentHashOpt";
    fn new_unchecked(data: molecule::bytes::Bytes) -> Self {
        PaymentHashOpt(data)
    }
    fn as_bytes(&self) -> molecule::bytes::Bytes {
    ...
    fn from_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        PaymentHashOptReader::from_slice(slice).map(|reader| reader.to_entity())
    }
    fn from_compatible_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        PaymentHashOptReader::from_compatible_slice(slice).map(|reader| reader.to_entity())
    }
    fn new_builder() -> Self::Builder {
        ::core::default::Default::default()
    }
...
#[derive(Clone, Copy)]
pub struct PaymentHashOptReader<'r>(&'r [u8]);
impl<'r> ::core::fmt::LowerHex for PaymentHashOptReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::core::fmt::Debug for PaymentHashOptReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::core::fmt::Display for PaymentHashOptReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        if let Some(v) = self.to_opt() {
            write!(f, "{}(Some({}))", Self::NAME, v)
        } else {
...
impl<'r> PaymentHashOptReader<'r> {
    ...
    pub fn to_opt(&self) -> Option<PaymentHashReader<'r>> {
        if self.is_none() {
            None
        } else {
            Some(PaymentHashReader::new_unchecked(self.as_slice()))
        }
    }
}
impl<'r> molecule::prelude::Reader<'r> for PaymentHashOptReader<'r> {
    type Entity = PaymentHashOpt;
    const NAME: &'static str = "PaymentHashOptReader";
    fn to_entity(&self) -> Self::Entity {
        Self::Entity::new_unchecked(self.as_slice().to_owned().into())
    }
    fn new_unchecked(slice: &'r [u8]) -> Self {
        PaymentHashOptReader(slice)
    }
    fn as_slice(&self) -> &'r [u8] {
        self.0
    }
    fn verify(slice: &[u8], compatible: bool) -> molecule::error::VerificationResult<()> {
        if !slice.is_empty() {
            PaymentHashReader::verify(&slice[..], compatible)?;
        }
        Ok(())
    }
}
#[derive(Clone, Debug, Default)]
pub struct PaymentHashOptBuilder(pub(crate) Option<PaymentHash>);
impl PaymentHashOptBuilder {
    pub fn set(mut self, v: Option<PaymentHash>) -> Self {
        self.0 = v;
        self
    }
}
impl molecule::prelude::Builder for PaymentHashOptBuilder {
    type Entity = PaymentHashOpt;
    const NAME: &'static str = "PaymentHashOptBuilder";
    fn expected_length(&self) -> usize {
        self.0
            .as_ref()
            .map(|ref inner| inner.as_slice().len())
    ...
    fn build(&self) -> Self::Entity {
        ...
        self.write(&mut inner)
            .unwrap_or_else(|_| panic!("{} build should be ok", Self::NAME));
        PaymentHashOpt::new_unchecked(inner.into())
    }
}
impl From<PaymentHash> for PaymentHashOpt {
    fn from(value: PaymentHash) -> Self {
        Self::new_builder().set(Some(value)).build()
    }
}
...
impl RawDataPartBuilder {
    ...
    pub fn description(mut self, v: BytesOpt) -> Self {
        self.description = v;
        self
    }
}
