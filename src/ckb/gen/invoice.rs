...
impl From<[Byte; 32usize]> for PaymentSecret {
    fn from(value: [Byte; 32usize]) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl ::core::convert::TryFrom<&[Byte]> for PaymentSecret {
    type Error = ::core::array::TryFromSliceError;
    fn try_from(value: &[Byte]) -> Result<Self, ::core::array::TryFromSliceError> {
        Ok(Self::new_builder()
            .set(<&[Byte; 32usize]>::try_from(value)?.clone())
...
impl From<PaymentSecret> for [Byte; 32usize] {
    #[track_caller]
...
impl From<[u8; 32usize]> for PaymentSecret {
    fn from(value: [u8; 32usize]) -> Self {
        PaymentSecretReader::new_unchecked(&value).to_entity()
    }
}
impl ::core::convert::TryFrom<&[u8]> for PaymentSecret {
    type Error = ::core::array::TryFromSliceError;
    fn try_from(value: &[u8]) -> Result<Self, ::core::array::TryFromSliceError> {
        Ok(<[u8; 32usize]>::try_from(value)?.into())
    }
}
impl From<PaymentSecret> for [u8; 32usize] {
    #[track_caller]
    fn from(value: PaymentSecret) -> Self {
        ::core::convert::TryFrom::try_from(value.as_slice()).unwrap()
    }
}
impl<'a> From<PaymentSecretReader<'a>> for &'a [u8; 32usize] {
    #[track_caller]
    fn from(value: PaymentSecretReader<'a>) -> Self {
        ::core::convert::TryFrom::try_from(value.as_slice()).unwrap()
    }
}
impl<'a> From<&'a PaymentSecretReader<'a>> for &'a [u8; 32usize] {
    #[track_caller]
    fn from(value: &'a PaymentSecretReader<'a>) -> Self {
        ::core::convert::TryFrom::try_from(value.as_slice()).unwrap()
    }
}
#[derive(Clone)]
