...
use ckb_pcn_invoice::payment::payment_parameters_from_invoice;
use ckb_pcn_invoice::payment::payment_parameters_from_zero_amount_invoice;
use ckb_pcn_invoice::{utils, Bolt11Invoice, Currency};
            ...
            match word {
                ...
                "sendonionmessage" => {
                    ...
                    match onion_messenger.send_onion_message(
                        ...
                        Ok(success) => {
                            println!(
                                "SUCCESS: forwarded onion message to first hop {:?}",
                                success
                            )
                        }
...
fn list_payments(
    ...
    outbound_payments: &OutboundPaymentInfoStorage,
) {
    print!("[");
...
fn get_invoice(
    amt_msat: u64,
    inbound_payments: &mut InboundPaymentInfoStorage,
    channel_manager: &ChannelManager,
    keys_manager: Arc<KeysManager>,
    network: Network,
    expiry_secs: u32,
