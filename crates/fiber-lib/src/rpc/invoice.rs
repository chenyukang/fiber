...
pub struct NewInvoiceParams {
    ...
    /// The preimage to settle an incoming TLC payable to this invoice. If preimage is set, hash should not. If both preimage and hash are absent, a random preimage is generated.
    pub payment_preimage: Option<Hash256>,
    /// The hash of the preimage. If hash is set, preimage should be absent. This condition indicates a 'hold invoice' for which the tlc must be accepted and held until the preimage becomes known.
